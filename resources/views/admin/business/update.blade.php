                    ...
                    <form action="{{ route('admin/services/update', $services->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="Title" value="{{ $services->title }}">
                                @error('title')
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" name="category" class="form-control" placeholder="Category" value="{{ $services->category }}">
                                @error('category')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" name="body" class="form-control" placeholder="Body" value="{{ $services->body }}">
                                @error('body')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
