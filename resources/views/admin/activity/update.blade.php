                ...
                <div class="px-6 py-4">
                    ...
                    <form action="{{ route('admin/activities/update', $activities->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="title" name="title" placeholder="Activity Title" value="{{ $activities->title }}" required>
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" id="body" name="body" placeholder="Activity Body Text">{{ $activities->body }}</textarea>
                            @error('body')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
